...
export default React.memo(function MotorcycleList({id, image, motorcycleName, price}: Motorcycle) {
    ...
    return (
        <View style={{backgroundColor: "white", flex: 0.5, marginVertical: 10, marginHorizontal: 8, borderRadius: 10, overflow: "hidden"}}>
            <TouchableOpacity onPress={()=> navigation.navigate('MotorcycleDetail', {motorcycleName, image, id, price})}>
                ...
                <View style={{paddingHorizontal: 5, paddingBottom: 5}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: "center"}}>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            <Text style={{fontWeight: '500'}}>4.8</Text>
                        </View>
