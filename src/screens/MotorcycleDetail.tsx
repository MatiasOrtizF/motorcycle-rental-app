...
import { Features, PaymentStatus } from '../types';
...
export default function MotorcycleDetail({route}: motorcycleDetailProps) {
    ...
    const paymentStatus: PaymentStatus[] = [
        {title: 'Date rental', value: dayRental},
        {title: 'Date return', value: dayReturn},
                                ...
                                <View>
                                    ...
                                    {paymentStatus.map((payment, index)=> (
                                        ...
                                        :
                                            ...
                                            <View key={index} style={{flexDirection: "row", justifyContent: "space-between", marginTop: payment.value === dayReturn ? 5 : 0}}>
                                                <Text>{payment.title}</Text>
                                                <Text style={{fontWeight: "600"}}>{payment.value}</Text>
                                            </View>
                                        </>
                                    ))}
                                </View>
